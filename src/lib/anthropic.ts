...
3. EVIDENCE: This is the most critical part. You must:
   ...
   - The highlighted portions, when read in sequence, must form COHERENT SENTENCES that support the tag
   - Non-highlighted text should be present but will appear smaller/lighter
   - Include as much surrounding context as possible

HIGHLIGHTING RULES:
- Highlighted text (wrapped in <mark> tags) forms the "reading" of the card
- When you read ONLY the highlighted portions in order, they should form grammatically coherent sentences
- Highlight complete phrases, not individual words (unless a single word completes a sentence)
- You can highlight across sentence boundaries to form new coherent statements
- Non-highlighted text provides context and credibility but is not read in competition
- Be strategic: highlight the strongest warrants, impacts, and claims
- Include enough highlighting to make a complete argument (usually 3-8 highlighted sections per paragraph)
